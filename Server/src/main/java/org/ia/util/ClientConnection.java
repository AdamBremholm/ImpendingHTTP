    ...
    public void run() {
        ...
        try {
             ...
             */
                ...
                String jsonString = JsonParser.urlToJson(payload.toString());
                ...
                if (clientRequest.isGet() && clientRequest.getFile().startsWith("/json")) {
                    String jsonString = JsonParser.urlToJson(clientRequest.getFile());
                    ...
                    out.println("Date: " + new Date());
                    out.println("Content-type: " + clientRequest.getContentType());
                    out.println("Content-length: " + jsonByte.length);
                    out.println(); // blank line between headers and content, very important !
                    out.flush(); // flush character output stream buffer

                    dataOut.write(jsonByte);
                    dataOut.flush();
